...
<p align="center">
  ...
  <i>基于机器视觉引导的机械臂自动取放系统（MuJoCo 物理仿真）</i><br>
  <sub>面向 RoboMaster 2026 高校联盟赛工程挑战赛任务</sub>
</p>
...
<p align="center"><sub>
(a) detect &amp; align &nbsp;·&nbsp; (b) descend &amp; grasp &nbsp;·&nbsp; (c) lift &nbsp;·&nbsp;
(d) move to target &nbsp;·&nbsp; (e) place &nbsp;·&nbsp; (f) release &amp; retreat
</sub></p>
